...
public class View_Bills extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    tbl.setModel(
        new javax.swing.table.DefaultTableModel(
            new Object[][] {}, new String[] {"Bill number", "Total", "Time"}) {
    ...
    getContentPane()
        .add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 730, 260));
    ...
    btn_ViewBills.addActionListener(
    ...
    getContentPane()
        .add(btn_ViewBills, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 330, -1, -1));
    ...
    btn_DeleteBills.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    getContentPane()
        .add(btn_DeleteBills, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 330, -1, -1));

    jLabel2.setIcon(
        new javax.swing.ImageIcon(
            getClass().getResource("/Resources/Billing_background.png"))); // NOI18N
    getContentPane()
        .add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 200, 730, 200));

    jLabel1.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/Resources/white.jpg"))); // NOI18N
    getContentPane()
        .add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 727, 399));

    pack();
  } // </editor-fold>//GEN-END:initComponents

  private void btn_ViewBillsActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_btn_ViewBillsActionPerformed
  ...
  private void btn_DeleteBillsActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_btn_DeleteBillsActionPerformed
    // TODO add your handling code here:
    DefaultTableModel mytable = (DefaultTableModel) tbl.getModel();
    int DialogueResult =
        JOptionPane.showConfirmDialog(null, "Are you sure you want to delete the selected bills?");
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      java.util.logging.Logger.getLogger(View_Bills.class.getName())
