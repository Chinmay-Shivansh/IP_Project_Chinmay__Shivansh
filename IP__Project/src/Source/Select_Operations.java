...
public class Select_Operations extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    getContentPane()
        .add(btnBilling, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 113, 100, 30));
    ...
    getContentPane()
        .add(btnMenu, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 113, 100, 30));
    ...
    getContentPane()
        .add(btnFeedback, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 200, 130, 30));

    Back_button.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/Resources/Back_white.png"))); // NOI18N
    ...
    getContentPane()
        .add(Back_button, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 110, -1, 30));
    ...
    btnViewBills.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    getContentPane()
        .add(btnViewBills, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 280, 260, -1));

    jLabel2.setIcon(
        new javax.swing.ImageIcon(
            getClass().getClassLoader().getResource("Resources/SelectOperations_background.jpg")));
    getContentPane()
        .add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 690, 380));

    pack();
  } // </editor-fold>//GEN-END:initComponents

  private void btnMenuActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_btnMenuActionPerformed
  ...
  private void btnBillingActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_btnBillingActionPerformed
    // TODO add your handling code here:
  ...
  private void btnFeedbackActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_btnFeedbackActionPerformed
    // TODO add your handling code here:
  ...
  private void btnViewBillsActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_btnViewBillsActionPerformed
    // TODO add your handling code here:
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      java.util.logging.Logger.getLogger(Select_Operations.class.getName())
