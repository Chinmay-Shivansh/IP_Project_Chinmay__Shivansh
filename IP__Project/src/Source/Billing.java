...
public class Billing extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    tbl.setModel(
        new javax.swing.table.DefaultTableModel(
            new Object[][] {}, new String[] {"Item", "Price", "Quantity", "Amount"}) {
    ...
    getContentPane()
        .add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 20, 370, 330));

    jLabel2.setFont(new java.awt.Font("Google Sans Medium", 0, 12)); // NOI18N
    jLabel2.setForeground(java.awt.Color.darkGray);
    jLabel2.setText("Quantity");
    getContentPane()
        .add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 40, 60, 20));

    txtQty.setFont(new java.awt.Font("Google Sans", 0, 11)); // NOI18N
    getContentPane()
        .add(txtQty, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 70, 70, 20));
    ...
    getContentPane()
        .add(btnAdd, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 110, 60, -1));
    ...
    getContentPane()
        .add(btnBill, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 190, 130, 90));
    ...
    getContentPane()
        .add(btnClear, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 330, -1, -1));
    ...
    getContentPane()
        .add(btnRemove, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 140, 120, -1));

    jLabel4.setIcon(
        new javax.swing.ImageIcon(getClass().getClassLoader().getResource("Resources/cash.png")));
    getContentPane()
        .add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 110, 62, 62));

    jLabel5.setIcon(
        new javax.swing.ImageIcon(getClass().getClassLoader().getResource("Resources/card.png")));
    getContentPane()
        .add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 250, 62, 62));

    jLabel6.setFont(new java.awt.Font("Google Sans Medium", 0, 12)); // NOI18N
    jLabel6.setForeground(java.awt.Color.darkGray);
    jLabel6.setText("Item");
    getContentPane()
        .add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 40, 50, -1));
    getContentPane()
        .add(lblTotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 290, 50, 20));

    jLabel7.setFont(new java.awt.Font("Google Sans Medium", 0, 14)); // NOI18N
    jLabel7.setForeground(java.awt.Color.darkGray);
    jLabel7.setText("Total:");
    getContentPane()
        .add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 290, -1, 20));
    ...
    getContentPane()
        .add(cmbItem, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 70, 130, -1));

    jLabel1.setIcon(
        new javax.swing.ImageIcon(getClass().getClassLoader().getResource("Resources/white.jpg")));
    getContentPane()
        .add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 730, 370));
  ...
  private void btnAddActionPerformed(
    ...
    try {
      ...
      Statement stmt = con.createStatement();
      String str =
          "select * from menu where Item = '" + cmbItem.getSelectedItem().toString() + "';";
      ResultSet rs = stmt.executeQuery(str);
      while (rs.next()) {
  ...
  private void btnBillActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_btnBillActionPerformed
    // TODO add your handling code here:
  ...
  private void cmbItemActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_cmbItemActionPerformed
    // TODO add your handling code here:
