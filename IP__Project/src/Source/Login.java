...
public class Login extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    getContentPane()
        .add(txtuname, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 230, 110, -1));
    ...
    getContentPane()
        .add(btnLogin, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 340, 90, -1));

    pwd_field.setFont(new java.awt.Font("Google Sans", 0, 12)); // NOI18N
    getContentPane()
        .add(pwd_field, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 280, 110, -1));

    jLabel3.setFont(new java.awt.Font("Google Sans", 1, 12)); // NOI18N
    jLabel3.setForeground(java.awt.Color.darkGray);
    jLabel3.setText("Password");
    getContentPane()
        .add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 280, -1, 20));

    jLabel1.setFont(new java.awt.Font("Google Sans", 1, 12)); // NOI18N
    jLabel1.setForeground(java.awt.Color.darkGray);
    jLabel1.setText("Username (Employee ID)");
    getContentPane()
        .add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 230, -1, 20));

    jLabel4.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/Resources/Login_icon.gif"))); // NOI18N
    ...
    getContentPane()
        .add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 30, 170, 140));

    jLabel5.setIcon(
        new javax.swing.ImageIcon(
            getClass().getResource("/Resources/Login_background.png"))); // NOI18N
    getContentPane()
        .add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 270, 450));

    jLabel2.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/Resources/white.jpg"))); // NOI18N
    getContentPane()
        .add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 670, 450));
